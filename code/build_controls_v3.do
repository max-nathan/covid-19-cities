...
global imd			https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/834001/File_11_-_IoD2019_Local_Authority_District_Summaries__upper-tier__.xlsx
...
import excel using "$imd", sheet("IMD") first clear 
ren UpperTierLocalAuthorityDistr lad_code
ren B lad_name
drop if lad_code=="" 

foreach var in IMDRankofaveragerank IMDRankofaveragescore IMDProportionofLSOAsinmos IMD2019Extent IMD2019Rankofextent IMD2019Localconcentration IMD2019Rankoflocalconcent {

	gen c = `var' if lad_code=="E06000052" 			// merge cornwall and isles of scilly 
	gen ios = `var' if lad_code=="E06000053"
	replace `var' = c+ios if lad_code=="E06000052" 
	drop if lad_code=="E06000053"
	drop c ios  
	}
