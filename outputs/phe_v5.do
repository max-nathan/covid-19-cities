...
- run the r script inside stata to import the phe data 
...
/* r script to import phe data, kinda ridiculous, but import delim doesn't seem to work rn 
* tidy this using https://fsolt.org/blog/2018/08/15/switch-to-r.html

today = Sys.Date()

casedata = read.csv("https://coronavirus.data.gov.uk/downloads/csv/coronavirus-cases_latest.csv")
cases = "/Users/max/Dropbox/academic/projects/04_Ideas/COVID-19_cities/data/phe/coronavirus-cases-latest"
...
deaths = "/Users/max/Dropbox/academic/projects/04_Ideas/COVID-19_cities/data/phe/coronavirus-cdeaths-latest"
